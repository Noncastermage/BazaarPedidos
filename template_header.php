  ...
  <div class="container">
      <header>
          ...
          <nav id="main-nav" class="main-nav">
              ...
              <a href="view_orders.php" class="<?= $current_page == 'view_orders.php' || $current_page == 'view_order.php' || $current_page == 'edit_order.php' ? 'active' : '' ?>">
      ...
      <main>
          ...
          <?php if (isset($warningMessage) && !empty($warningMessage)): ?>
              <div class="alert warning">
                  <?= htmlspecialchars_decode($warningMessage) ?>
              </div>
          <?php endif; ?>
</main>
